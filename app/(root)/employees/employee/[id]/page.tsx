    ...
    return (
      <div className='min-h-screen bg-gray-50 py-8'>
        <div className='container mx-auto px-4'>
          ...
          <p className='text-gray-600 mt-2'>لا يمكن العثور على الموظف المطلوب.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className='min-h-screen bg-gray-50 py-8'>
      <div className='container mx-auto px-4 space-y-6'>
        ...
        <Card>
          <CardHeader>
            <CardTitle className='text-xl text-gray-900'>المعلومات الأساسية</CardTitle>
          ...
          <CardContent className='space-y-4'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              <div className='space-y-2'>
                ...
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.name}</p>
              </div>
              
              <div className='space-y-2'>
                <label className='text-sm font-medium text-gray-700'>اسم الشهرة</label>
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.nickName}</p>
              </div>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.profession}</p>
              </div>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.phoneNumber}</p>
              </div>
              
              {employee.email && (
                <div className='space-y-2'>
                  <label className='text-sm font-medium text-gray-700'>البريد الإلكتروني</label>
                  <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.email}</p>
                </div>
              )}
            </div>
            ...
            <div className='space-y-4'>
              <div className='space-y-2'>
                ...
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.residenceLocation}</p>
              </div>
              
              {employee.notes && (
                <div className='space-y-2'>
                  <label className='text-sm font-medium text-gray-700'>ملاحظات</label>
                  <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.notes}</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className='text-xl text-gray-900'>المعلومات الوظيفية</CardTitle>
          ...
          <CardContent>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div className='space-y-2'>
                ...
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.administration}</p>
              </div>
              
              <div className='space-y-2'>
                <label className='text-sm font-medium text-gray-700'>العمل الفعلي</label>
                <p className='text-gray-900 bg-gray-50 p-3 rounded-md'>{employee.actualWork}</p>
              </div>
        ...
        {employee.relationships && employee.relationships.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className='text-xl text-gray-900'>العلاقات العائلية</CardTitle>
                  ...
                  <div key={relationship.id} className='border rounded-lg p-4 bg-white'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                      <div className='space-y-2'>
                        ...
                        <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.name}</p>
                      </div>
                      ...
                      {relationship.birthPlace && (
                        <div className='space-y-2'>
                          <label className='text-sm font-medium text-gray-700'>مكان الميلاد</label>
                          <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.birthPlace}</p>
                        </div>
                      )}
                      ...
                      {relationship.profession && (
                        <div className='space-y-2'>
                          <label className='text-sm font-medium text-gray-700'>المهنة</label>
                          <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.profession}</p>
                        </div>
                      )}
                      
                      {relationship.spouseName && (
                        <div className='space-y-2'>
                          <label className='text-sm font-medium text-gray-700'>اسم الزوج/الزوجة</label>
                          <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.spouseName}</p>
                        </div>
                      )}
                      
                      <div className='space-y-2'>
                        <label className='text-sm font-medium text-gray-700'>محل الإقامة</label>
                        <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.residenceLocation}</p>
                      </div>
                      
                      {relationship.notes && (
                        <div className='space-y-2 md:col-span-2 lg:col-span-3'>
                          <label className='text-sm font-medium text-gray-700'>ملاحظات</label>
                          <p className='text-gray-900 bg-gray-50 p-2 rounded-md text-sm'>{relationship.notes}</p>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-center py-8'>
                ...
                <h3 className='text-lg font-medium text-gray-900 mb-1'>لا توجد علاقات عائلية مسجلة</h3>
                <p className='text-gray-500'>لم يتم إضافة أي معلومات عن الأقارب لهذا الموظف</p>
              </div>
            </CardContent>
          </Card>
        )}
        ...
        <Card>
          <CardHeader>
            <CardTitle className='text-xl text-gray-900'>معلومات النظام</CardTitle>
